...
// most of the code on this page comes from Bill Chadwick's World Magnetic Model
// js port, found at http://wtp2.appspot.com/WorldMagneticModel.js.
...
chrome.runtime.onMessage.addListener(
  function(request, sender, sendResponse) {
	...
	var wmm = new WorldMagneticModel();
	var dec = wmm.declination(0.0, request.lat, request.long,2014.5); 
	console.log('got dec of ' + dec );
	sendResponse({magdec: dec});
  });
